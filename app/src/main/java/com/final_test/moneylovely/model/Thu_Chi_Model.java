...
public class Thu_Chi_Model  {
    ...
    public Thu_Chi_Model(int id, String nameCV, String money, String donviThu, int danhGia, int deleteFlag, String date, String ghiChu, byte[] img, int idLoai, int idUser) {
        this.id = id;
        this.nameCV = nameCV;
        this.money = money;
